 ...
 * - applyInjury
 */
export type PreApplyInjury = (message: ChatMessage, actor: CosmereActor | null, data: {
    type: InjuryType;
    duration: number;
}) => boolean;
export type ApplyInjury = (message: ChatMessage, actor: CosmereActor | null, injury: InjuryItem) => boolean;
/**
 * --- Rest hooks ---
 * - preRest
 * - rest
